# =============================================================
# realisieren-pulse.spec — PyInstaller build specification
# =============================================================
...
# ── app_icon.png — bundled so the UI image loads from _HERE in frozen mode ──
_png_src  = _os.path.join('..', 'imgs', 'app_icon.png')
_png_datas = [(_png_src, '.')] if _os.path.exists(_png_src) else []
...
a = Analysis(
    ...
    # app_icon.png     → UI image shown in login/dashboard/header
    datas=_icon_datas + _app_icon_datas + _png_datas,
